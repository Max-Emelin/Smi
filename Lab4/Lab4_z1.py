...
input_file = 'Lab4\data_singlevar_regr.txt'
...
print("\nNew mean absolute error (num_training = ",num_training,") = ", round(sm.mean_absolute_error(y_test, y_test_pred_new), 2))